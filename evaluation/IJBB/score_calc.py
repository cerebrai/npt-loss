...
templates, medias = read_template_media_list(os.path.join(main_dir + '/IJBB/meta', 'ijbb_face_tid_mid.txt'))
p1, p2, label = read_template_pair_list(os.path.join(main_dir + '/IJBB/meta', 'ijbb_template_pair_label.txt'))
